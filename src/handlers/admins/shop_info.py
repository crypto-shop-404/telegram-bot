...
@dp.message_handler(filters.Text('🏪 Shop Information'), is_user_in_db.IsUserInDB(), is_admin.IsUserAdmin())
...
@dp.message_handler(filters.Text('👋 Greetings'), is_user_in_db.IsUserInDB(), is_admin.IsUserAdmin())
...
@dp.message_handler(filters.Text('✋ Return'), is_user_in_db.IsUserInDB(), is_admin.IsUserAdmin())
...
@dp.callback_query_handler(callback_factories.ShopInformationFactory().filter(object='faq', action='edit'),
...
@dp.message_handler(is_user_in_db.IsUserInDB(), is_admin.IsUserAdmin(),
                    state=shop_info_states.EditFAQ.waiting_faq)
...
@dp.callback_query_handler(callback_factories.ShopInformationFactory().filter(object='rules', action='edit'),
                           is_user_in_db.IsUserInDB(), is_admin.IsUserAdmin())
...
@dp.message_handler(is_user_in_db.IsUserInDB(), is_admin.IsUserAdmin(),
                    state=shop_info_states.EditRules.waiting_rules)
...
@dp.callback_query_handler(callback_factories.ShopInformationFactory().filter(object='greetings', action='edit'),
                           is_user_in_db.IsUserInDB(), is_admin.IsUserAdmin())
...
@dp.message_handler(is_user_in_db.IsUserInDB(), is_admin.IsUserAdmin(),
                    state=shop_info_states.EditGreetings.waiting_greetings)
...
@dp.callback_query_handler(callback_factories.ShopInformationFactory().filter(
    object='comeback_message', action='edit'), is_user_in_db.IsUserInDB(), is_admin.IsUserAdmin()
)
...
@dp.message_handler(is_user_in_db.IsUserInDB(), is_admin.IsUserAdmin(),
                    state=shop_info_states.EditComebackMessage.waiting_comeback_message)
